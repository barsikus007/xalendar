...
export default function MonthDay(props) {
  ...
  const classes = [
    (moment(props.day).month() === moment(props.currentDate).month())
      ? 'calendar-month-week-day'
      : 'calendar-month-week-day__othermonth'
  ]

  if (moment().format('YYYY-MM-DD')===moment(props.day).format('YYYY-MM-DD'))
    classes.push('calendar-month-week-day__today')
